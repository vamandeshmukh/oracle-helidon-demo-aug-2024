...
@NamedQueries({ @NamedQuery(name = "getPokemons", query = "SELECT p FROM Pokemon p"), // JPQL
		@NamedQuery(name = "getPokemonByName", query = "SELECT p FROM Pokemon p WHERE p.name = :name") }) // // JPQL
